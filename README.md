...
Codex Skill for drafting Chinese invention patent application documents from technical disclosures, innovation points, experimental results, program logic, calculation methods, device structures, system architectures, and engineering application scenarios.
...
This skill helps generate Chinese invention patent drafts, including title, abstract, claims, specification, abstract drawing guidance, and optional Python code for patent figures or result plots.
